    ...
    <el-card shadow="never" class="border-0">
        <Search :model="searchForm" @reset="resetSearchForm" @search="getData">
            <SearchItem label="关键词">
                <el-input v-model="searchForm.keyword" placeholder="手机号/邮箱/会员名称" clearable></el-input>
            </SearchItem>
            <template #show>
                <SearchItem>
            ...
            <el-table-column label="操作" width="180" align="center">
                <template #default="scope">
                    ...
                    <div v-else>
                        ...
                        <el-popconfirm width="220" title="是否确定要删除该记录？" confirm-button-text="确认" cancel-button-text="取消"
...
import { getUserList, updateUserStatus, updateUser, deleteUser, createUser } from '~/api/user'
