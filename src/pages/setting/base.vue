            ...
            <el-tabs v-model="activeName">
                ...
                <el-tab-pane label="上传设置" name="second">
                    ...
                    <el-form-item label="Bucket">
                        <el-input v-model="form.upload_config.Bucket" placeholder="Bucket" clearable
                            style="width:30%"></el-input>
                    </el-form-item>
                    <el-form-item label="ACCESS_KEY">
                        <el-input v-model="form.upload_config.ACCESS_KEY" placeholder="ACCESS_KEY" clearable
                            style="width:30%"></el-input>
                    </el-form-item>
                    <el-form-item label="SECRET_KEY">
                        <el-input v-model="form.upload_config.SECRET_KEY" placeholder="SECRET_KEY" clearable
                            style="width:30%"></el-input>
                    </el-form-item>
                    <el-form-item label="空间域名">
                        <el-input v-model="form.upload_config.http" placeholder="空间域名" clearable
                            style="width:30%"></el-input>
                        <small class="text-gray-500 flex mt-1 ml-1">请补全 http://或 https://</small>
                    </el-form-item>
                </el-tab-pane>
                <el-tab-pane label="Api安全" name="third">
                    <el-form-item label="是否开启API安全">
                        ...
                        <small class="text-gray-500 flex mt-1 ml-1">api安全功能开启之后调用前端api需要传输签名串</small>
                    </el-form-item>
                    <el-form-item label="秘钥">
                        <el-input v-model="form.api_secret" placeholder="秘钥" clearable style="width:30%"></el-input>
