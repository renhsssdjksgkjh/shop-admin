<template>
    <div v-loading="loading" class="bg-white p-4 rounded">
        <el-form :model="form" label-width="160px">
            <h5 class="bg-gray-100 p-3 rounded mb-3">基础设置</h5>
            ...
            <h5 class="bg-gray-100 p-3 rounded mb-3">返佣设置</h5>
            <el-form-item label="一级返佣比例">
                <div>   
                    <el-input v-model="form.store_first_rebate" placeholder="一级返佣比例" type="number" style="width:50%">
                        <template #append>%</template>
                    </el-input>
                    <small class="text-gray-500 flex mt-1 ml-1">订单交易成功后给上级返佣的比例0 - 100,例:5 = 反订单金额的5%</small>
                </div>
            </el-form-item>
            ...
            <el-form-item label="自购返佣">
                <div>
                    ...
                    <small class="text-gray-500 flex mt-1 ml-1">是否开启自购返佣（开启：分销员自己购买商品，享受一级返佣，上级享受二级返佣；
                        关闭：分销员自己购买商品没有返佣）</small>
                </div>
            </el-form-item>
            <h5 class="bg-gray-100 p-3 rounded mb-3">结算设置</h5>
            <el-form-item label="结算时间">
                <div>
                    ...
                    <small class="text-gray-500 flex mt-1 ml-1">预估佣金结算后无法进行回收，请谨慎设置结算天数</small>
                </div>
            </el-form-item>
            <el-form-item label="佣金到账方式">
                <div>
                    ...
                    <small class="text-gray-500 flex mt-1 ml-1">佣金到账方式支持线下转账和微信零钱自动转账，手动转账更安全，自动转账更方便</small>
                </div>
            </el-form-item>
            <el-form-item>
