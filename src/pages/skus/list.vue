<template>
    <el-card shadow="never" class="border-0">
        ...
        <ListHeader layout="create,delete,refresh" @refresh="getData" @create="handleCreate"
            @delete="handleMultiDelete"></ListHeader>
        ...
        <el-table ref="multipleTableRef" :data="tableData" stripe style="width: 100%" v-loading="loading"
            ...
            <el-table-column label="操作" width="250" align="center">
                <template #default="scope">
                    ...
                    <el-popconfirm width="220" title="是否确定要删除该规格？" confirm-button-text="确认" cancel-button-text="取消"
